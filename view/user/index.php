<?php require("C:/xampp/htdocs/ccrud/view/template/header_user.php");?>
  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(C:/xampp/htdocs/ccrud/assets/img/slide/1.jpeg)">
  ...
  <?php require("C:/xampp/htdocs/ccrud/view/template/footer_user.php");?>
